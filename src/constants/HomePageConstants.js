export const STARBUCKS_LOGO = "https://upload.wikimedia.org/wikipedia/en/thumb/d/d3/Starbucks_Corporation_Logo_2011.svg/1200px-Starbucks_Corporation_Logo_2011.svg.png"

export const HOME_SCREEN_TOP = "We’re working hard to put the health and well-being of our partners and customers first in all that we do."

export const HOME_SCREEN_STARBUCKS_PEOPLE = "https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-68026.jpg"

export const HOME_SCREEN_BOTTOM_LEFT = {
    heading: "Investing in our communities",
    paragraph: "The Starbucks Foundation awarded grants to over 400 nonprofits serving communities of color. Recipients were nominated by Starbucks partners (employees)."
}

export const HOME_SCREEN_HEADING_1 = "Today Is Yours"
...
export const HOME_SCREEN_HEADING_2 = "More To Discover"
...
export const COPYRIGHT = "© 2021 Starbucks Coffee Company. All rights reserved."